...
def test_put():
    ...
    nt.assert_equal(sha, store.branch_head('master'))
...
def test_branch_merge():
    ...
    nt.assert_equal(sha, store.branch_head('b1'))
    ...
    nt.assert_equal(sha, store.branch_head('b2'))
    nt.assert_equal(store.get('bar'), "bar")
    ...
    nt.assert_equal(sha, store.branch_head('b3'))
    nt.assert_equal(sha, store.branch_head('master'))
